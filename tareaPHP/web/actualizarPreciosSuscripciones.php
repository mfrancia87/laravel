...
//si no está logueado o si no es administrador
  ...
  <div class="panel-body">
      <form method="post" action="../phpScripts/actualizarPreciosSuscripciones.php">
        <div class="form-group col-lg-6 col-sm-6 col-xs-12">
            ...
            <input type="number" step="0.1" class="form-control" name="silver" value="<?php echo $preciosPlanes[1]; ?>" required>
        </div>
         <div class="form-group col-lg-6 col-sm-6 col-xs-12">
            <label for="gold">Suscripción <strong>GOLD</strong>:</label>
            <input type="number" step="0.1" class="form-control" name="gold" value="<?php echo $preciosPlanes[2]; ?>"required>
        </div>
